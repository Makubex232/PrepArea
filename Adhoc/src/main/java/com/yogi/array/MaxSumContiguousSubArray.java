...
//		int[] inputArray = {-163, -20} ;
	...
	private int maxSubArray(int[] inputArray) {
		...
		for(int i=1 ;i<inputArray.length; i++) {
			...
			System.out.println("index :: "+i+"\tinput :: "+inputArray[i]+"\tmaxEndingHere :: "+maxEndingHere +"\tmaxSoFar :: "+maxSoFar);
		}
